...
const colorList = [
    "#FFF", "#000", "#FFEBEE", "#FCE4EC" , "#F3E5F5", "#B39DDB" , "#9FA8DA", "#90CAF9" ,
     "#81D4FA", "#80DEEA" , "#4DB6AC", "#66BB6A" , "#CDDC39", "#FFEB3B" , "#FF9800"
]
let currentColorChoice = colorList[1];


const firebaseConfig = {
    apiKey: "AIzaSyBd1bbTOXMma9S-mATxnXif0sytZD-s8eY",
    authDomain: "pipixwar.firebaseapp.com",
    projectId: "pipixwar",
    storageBucket: "pipixwar.appspot.com",
    messagingSenderId: "760972237917",
    appId: "1:760972237917:web:63cf85b970b8cbc1c541b4"
  };
...
game.addEventListener('mousemove', function(event) {
    ...
    cursor.style.top = Math.floor(cursorTop / gridCellSize) * gridCellSize + 4 + "px";
